...
export const Default: Story = {
  render: () => (
    <NativeSelect aria-label="Difficulty" defaultValue="beginner">
...
export const Placeholder: Story = {
  render: () => (
    <NativeSelect aria-label="Difficulty" defaultValue="">
...
export const Disabled: Story = {
  render: () => (
    <NativeSelect aria-label="Difficulty" defaultValue="beginner" disabled>
      <option value="debut">Debut</option>
      <option value="beginner">Beginner</option>
      <option value="intermediate">Intermediate</option>
    </NativeSelect>
...
export const Invalid: Story = {
  render: () => (
    <NativeSelect aria-label="Difficulty" defaultValue="" aria-invalid>
      <option value="" disabled hidden>
        Select a difficulty…
      </option>
      <option value="debut">Debut</option>
...
export const WithGroups: Story = {
  render: () => (
    <NativeSelect aria-label="Instrument" defaultValue="snare">
...
export const ManyOptions: Story = {
  render: () => (
    <NativeSelect aria-label="Level" defaultValue="1">
