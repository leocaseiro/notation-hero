...
Direction **B (modern)**: big completion-% ring + 5★ + a verdict + "new best" badge; **per-state bars** (Perfect/Early/Late/Missed/Error, equal-width) + the **DT‑1 Target‑vs‑You** bars; streak / longest / max-combo / accuracy chips; Retry · Library · Next. Dedicated screen, so density is free. **Locked.**
