...
> **North-star:** a classic standalone drum-tutor (features, not palette). Internal reference screenshots tracked privately — see `docs/.private/` or the project's ~~Linear Document~~ <!-- Linear retired 2026-06-11; tracker is now Jira (project NH), https://leocaseiro.atlassian.net/jira/software/c/projects/NH/boards/2 — see docs/decisions/2026-06-11-tracker-linear-to-jira.md. Use the equivalent Jira (NH) document/page. --> Jira (NH) document.
