...
- **2026-06-05 (checkpoint):**
  ...
  - **Competitor-name scrub:** feature names use generic terms; load-bearing strategic refs kept (DT-1 north-star, Melodics-wedge analysis in design-stack.md, DT-1 screenshots).
...
| J-5 | Ghost-note dynamics detect + chart | Detect dynamics; DT-1-style dynamics chart | N | ✗ | L | — | M3 | reviewed | scope nice (dynamic detection) |
