...
| ID | Feature | Description | Scope | Fork | Est | AWS | Milestone | Status | Ref/Notes |
|---|---|---|---|---|---|---|---|---|---|
| G-1 | Friendly highway view | Melodics-style horizontal highway (primary) | N | ✗ | XL | — | Friendly | TBD | ✚ `/design-shotgun`; stack-brainstorm §6; PixiJS |
| G-1-a | Synthesia vertical alt | Vertical falling-notes alternate view | N | ✗ | L | — | Friendly | TBD | stack-brainstorm §6 |
...
| J-5 | Ghost-note dynamics detect + chart | Detect dynamics; DT-1-style dynamics chart | N | ✗ | L | — | M2 | TBD | scope nice (dynamic detection) |
