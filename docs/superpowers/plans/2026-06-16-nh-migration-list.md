...
>
> **How to bulk-move (per group):** Filters → paste the group's JQL → _Tools ▸ Bulk change_ → select all → _Edit issues_ → set **Parent** (the epic), **Sprint**, **Fix Version** in one pass. Best-effort mapping — adjust any row as you see fit.
>
