...
- **oRPC** (`@orpc/*`, canonical repo `middleapi/orpc`, docs orpc.dev) — ✅ very active (`1.14.6`, 2026-06-12; weekly releases; post-v1.0 Dec 2025; 5.3k★). *Caveat: primarily one maintainer (risk class ts-rest had) — mitigated by native OpenAPI exit ramp.*
...
| OpenAPI | ✅ native | ⚠️ limited | ✅✅ (it *is* the tool) | ❌ |
