...
- **AlphaTab formats:** _"AlphaTab has importers for Guitar Pro 3-5 (.gp3/.gp4/.gp5), GP6 (.gpx), GP7 (.gp), MusicXML (.xml), CapXML (.cap), and alphaTex… alphaTex does not support any kind of drum notation — drum support applies primarily to Guitar Pro and MusicXML."_
