...
export const ORP_ALL_VIEWER_EXCEPT_HOST = 'b689b0a8-53d0-40ab-baf2-68738e2966ac';
...
export class CloudFrontSite extends pulumi.ComponentResource {
  ...
  constructor(name: string, args: CloudFrontSiteArgs, opts?: pulumi.ComponentResourceOptions) {
    ...
    const lambdaOriginDomain = pulumi.output(args.functionUrl).apply((u) => new URL(u).hostname);
    ...
    const distribution = new aws.cloudfront.Distribution(
      `${name}-cdn`,
      {
        ...
        defaultCacheBehavior: {
          ...
          functionAssociations: [{ eventType: 'viewer-request', functionArn: spaRouter.arn }],
        },
